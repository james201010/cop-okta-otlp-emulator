...
public interface ApplicationConstants {
	...
	public static final String COP_ENGINE_METRIC_HANDLER_REQS_200 = "oag_promhttp_metric_handler_requests_200"; // Sum/Long 
	public static final String COP_ENGINE_METRIC_HANDLER_REQS_500 = "oag_promhttp_metric_handler_requests_500"; // Sum/Long 
	public static final String COP_ENGINE_METRIC_HANDLER_REQS_503 = "oag_promhttp_metric_handler_requests_503"; // Sum/Long 
	...
	public static final String COP_ENGINE_METRIC_HANDLER_ERRS_ENCODE = "oag_promhttp_metric_handler_errs_encode"; // Sum/Long 
	public static final String COP_ENGINE_METRIC_HANDLER_ERRS_GATHER = "oag_promhttp_metric_handler_errs_gather"; // Sum/Long 
	...
	// !!!! CPU
	public static final String OAG_CPU_METRIC_PFX = "OAG_node_cpu_";
	
	public static final String OAG_CPU_SECONDS = "OAG_node_cpu_seconds"; // Sum/Double
	public static final String COP_CPU_SECS_IDLE = "oag_cpu_secs_idle";  // Sum/Double
	public static final String COP_CPU_SECS_IOWAIT = "oag_cpu_secs_iowait"; // Sum/Double
	public static final String COP_CPU_SECS_IRQ = "oag_cpu_secs_irq"; // Sum/Double
	public static final String COP_CPU_SECS_NICE = "oag_cpu_secs_nice"; // Sum/Double
	public static final String COP_CPU_SECS_SOFTIRQ = "oag_cpu_secs_softirq"; // Sum/Double
	public static final String COP_CPU_SECS_STEAL = "oag_cpu_secs_steal"; // Sum/Double
	public static final String COP_CPU_SECS_SYSTEM = "oag_cpu_secs_system"; // Sum/Double
	public static final String COP_CPU_SECS_USER = "oag_cpu_secs_user"; // Sum/Double
	...
	public static final String COP_NET_RECEIVE_DROP = "oag_network_receive_drop"; // Sum/Double
	
	public static final String OAG_NET_RECEIVE_ERRS = "OAG_node_network_receive_errs"; // Sum/Double
	public static final String COP_NET_RECEIVE_ERRS = "oag_network_receive_errs"; // Sum/Double
	
	public static final String OAG_NET_RECEIVE_BYTES = "OAG_node_network_receive_bytes"; // Sum/Double
	public static final String COP_NET_RECEIVE_BYTES = "oag_network_receive_bytes"; // Sum/Double
